...
frame = tk.Frame(root, height=500)
...
describe_btn = tk.Button(ans_frame, text="Predict",font=("Arial", 12), command=lambda: getPrediction(data, checkVar1.get()))
